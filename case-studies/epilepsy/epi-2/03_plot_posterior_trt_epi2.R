...
plot_posterior_trt_default_all <- get_plot_posterior_trt_coeffs(plot_df_trt_all_default, fontsize = 4) +
...
theme_set(theme_classic() +
            theme(panel.grid.major = element_blank(),
                  ...
                  # decrease fontsize only for y-axis for plot of filtered models
...
save_tikz_plot(plot = plot_posterior_trt_combined, 
               width = 4.75,
               filename = here::here("case-studies", "epilepsy", "figures", "epi-2", "submission", "plot_extended_posterior_trt_default_vs_filtered.tex"))
