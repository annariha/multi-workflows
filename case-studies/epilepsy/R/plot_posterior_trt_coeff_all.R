...
df_plot_reduced <- models_combs_df |>
  ...
  select(posterior_draws_trt, median_post_trt, model_id, family) |>
...
save_tikz_plot(plot = plot_posterior_trt_coeff_all_reduced, 
               width = 5,
               filename = here::here("case-studies", "epilepsy", "figures", "epi-1", "plot_posterior_trt_coeff_all_reduced.tex"))
...
plot_posterior_trt_default_all <- get_plot_posterior_trt_coeffs(df_plot_trt_default_all, ytextsize = 4)
plot_posterior_trt_default_all

save_tikz_plot(plot = plot_posterior_trt_default_all, 
               width = 6.5,
               height = 8.5,
               filename = here::here("case-studies", "epilepsy", "figures", "epi-2", "plot_posterior_trt_coeff_all.tex"))