...
integrate(integrand_iter, 
          ...
          yj = y, 
          Xj = X,
          offsettj_plus_alpha = offsett_plus_alpha,
          beta = beta
          )
...
mean(dpois(
  x = yj, 
  lambda = exp(z_norm + offsett_plus_alpha + rowSums(X * beta)),
  log = FALSE))
```
